...
<% 
	...
	// 이미지 업로드해서 저장될 실제 위치
	String path="C:\\kgw\\newkgw-java\\jsp_study1\\src\\main\\webapp\\study\\image";
	// 업로드할 이미지의 최대 크기
	...
	try{
		...
		String file = (String)em.nextElement();	// 이미지 한 개만 업로드 하기 때문에 nextElement()
												// 한 번만 하면 된다.
	...
	sql = "insert into board_img(borad_id, img_name, img_path) values(?,?,?)";
