...
<div id="boardWrap">
	...
	<div id="boardBox">
		...
		<c:forEach var="row" items="${ list }">
			...
			<div id="pageNumbers">
				<ul id="pageNumList">
<%-- 			<a href="/board.do?page=${backPage}"><i class="bi bi-chevron-double-left"></i></a> --%>
			<a href="/board.do?page=${pageNum - skip < 1 ? 1 : pageNum - skip }"><i class="bi bi-chevron-double-left"></i></a>
...
<%-- 				<a href="/board.do?page=${nextPage}"><i class="bi bi-chevron-double-right"></i></a> --%>
				<a href="/board.do?page=${pageNum + skip > pageTotalNum ? pageTotalNum : pageNum+skip}"><i class="bi bi-chevron-double-right"></i></a>
				</ul>
			</div>
